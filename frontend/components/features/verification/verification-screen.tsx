      ...
      <div className="w-full max-w-lg">
        {!isComplete ? (
          ...
          <div className="animate-scale-in flex flex-col items-center text-center">
            ...
            <Button className="mt-10 h-13 w-full gap-2 rounded-xl bg-primary text-primary-foreground text-base font-semibold hover:bg-primary/90 shadow-xl shadow-primary/15 transition-all" onClick={() => { completeStep("dashboard"); router.push("/dashboard") }}>
