...
function NBFCfilter() {
  ...
  return (
    <div className="w-full">
            ...
            <button
              ...
              className={cn(
                ...
                active
                  ...
                  : "text-primary-foreground/35 hover:text-primary-foreground/60 hover:bg-primary-foreground/5",
              )}
            >
      ...
      {/* Count */}
      <p className="text-xs text-primary-foreground/30 mb-4">
        Showing{" "}
          ...
          {remaining > 0 && (
            <div className="mt-8 flex justify-center">
              <button
                ...
                className="flex items-center gap-1.5 rounded-full border border-primary-foreground/10 bg-primary-foreground/5 px-6 py-2.5 text-xs font-medium text-primary-foreground/40 transition-all hover:text-primary-foreground/60 hover:bg-primary-foreground/8 hover:border-primary-foreground/15"
              >
                {showAll ? (
                  <>
                    Show less
